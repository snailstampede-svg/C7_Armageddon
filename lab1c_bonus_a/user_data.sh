...
#########################################
# Ensure rsyslog is present so /var/log/messages exists for the CW Agent
dnf install rsyslog -y
systemctl enable rsyslog
systemctl start rsyslog
###########################################

###replace- pip3 install flask pymysql boto3 - with the three lines below
...
SECRET_ID = os.environ.get("SECRET_ID", "lab-1c/rds/mysql_v11")
...
Environment=SECRET_ID=lab-1c/rds/mysql_v11
